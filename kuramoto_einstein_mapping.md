...
| $\omega(x)$ — natural frequency | $\sqrt{4\pi G \rho(x)}$ — local Jeans frequency | **Matter sets the natural frequency.** Energy density determines how fast the local oscillator wants to tick. |
